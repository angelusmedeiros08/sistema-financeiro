              ...
              {linhas.map((linha) => {
                ...
                return (
                  <tr key={linha.atividade} className={cn("border-b border-border last:border-none", ehGeracaoCaixa && "bg-muted/40 font-bold")}>
                    ...
                    {linha.mesesPrevisto.map((previsto, i) => {
                      ...
                      return (
                        <Fragment key={i}>
                          ...
                          <td className={cn("py-1.5 px-1 text-right tabular-nums", variacao >= 0 ? "text-[#157F6B]" : "text-[#D8583A]")}>
                    ...
                    <td className={cn("py-1.5 px-1 text-right tabular-nums font-semibold", variacaoTotal >= 0 ? "text-[#157F6B]" : "text-[#D8583A]")}>
