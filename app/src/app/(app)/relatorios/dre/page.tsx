  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-6">
      ...
      <div className="rounded-2xl border border-border bg-card p-5">
        <h2 className="mb-4 font-heading text-sm font-bold text-foreground">Indicadores — evolução no ano</h2>
        <IndicadoresDreChart dados={indicadores} />
      </div>

      <div className="rounded-2xl border border-border bg-card p-5">
        <h2 className="mb-4 font-heading text-sm font-bold text-foreground">DRE em cascata — {ano}</h2>
        <WaterfallDre linhas={linhas.map((l) => ({ rotulo: l.rotulo, tipoCalc: l.tipoCalc, valorDireto: l.total }))} />
      </div>
