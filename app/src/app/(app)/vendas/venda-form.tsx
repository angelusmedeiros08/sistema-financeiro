...
export function VendaForm({
  ...
  const [estado, formAction, pendente] = useActionState(async (_: typeof estadoInicial, formData: FormData) => {
    ...
    const resultado =
      modo === "criar" ? await criarVendaAction(formData) : await editarVendaAction(vendaId!, formData);
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-1.5 lg:col-span-2">
            ...
            <PessoaCombobox
              ...
              perfil="CLIENTE"
              label="Cliente..."
              pessoaInicial={vendaInicial ? { id: vendaInicial.pessoaId, nome: vendaInicial.pessoaNome } : null}
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Select name="forma_pagamento_id" defaultValue={vendaInicial?.formaPagamentoId ?? undefined}>
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              min={1}
              required
              defaultValue={vendaInicial?.numeroParcelas ?? 1}
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Input
              ...
              type="date"
              required
              defaultValue={vendaInicial?.primeiroVencimento ?? dataEmissaoInicial}
            />
          </div>
          <div className="space-y-1.5 lg:col-span-2">
