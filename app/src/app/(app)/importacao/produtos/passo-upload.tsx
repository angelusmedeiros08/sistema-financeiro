...
import { gerarModeloCsvProdutos } from "@/lib/importacao/produtos/template";
import { baixarArquivoTexto } from "@/lib/importacao/download";

export function PassoUpload({ onAvancar }: { onAvancar: (dados: { arquivo: File; buffer: ArrayBuffer; parse: ResultadoParse }) => void }) {
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Aceita .csv e .xlsx, até 10MB e 500 linhas. Produtos e serviços podem estar misturados na mesma planilha.
          </p>
        </div>
        <Button
          type="button"
          ...
          onClick={() => baixarArquivoTexto("modelo-produtos.csv", gerarModeloCsvProdutos())}
        >
