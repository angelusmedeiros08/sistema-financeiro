...
const SECOES: SecaoConfig[] = [
  ...
  { tipo: "pessoa", titulo: "Clientes / Fornecedores", campo: "pessoa", obrigatoria: false },
...
export function PassoEntidades({
  ...
  const todasResolvidas = secoes.every((secao) =>
  ...
  async function avancar() {
    ...
    if (paraCriar.length === 0) {
      onAvancar(montarMapaFinal(secoes, decisoes), []);
      return;
    }
    ...
    onAvancar(montarMapaFinal(secoes, decisoesAtualizadas), categoriasNovas);
  }
