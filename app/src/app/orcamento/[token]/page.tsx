...
import { buscarOrcamentoPorToken } from "@/lib/orcamentos-comerciais/orcamento-publico";
...
// abre a policy staff-only de orcamentos_comerciais/orcamento_comercial_itens
// pra `anon`: a leitura passa pelo client administrativo dentro de
// buscarOrcamentoPorToken, filtrada pelo token da URL, que já é a única
// autorização que existe aqui.
